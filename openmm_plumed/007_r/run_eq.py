...
plumed_file = osp.realpath('plumed_eq.dat')
coords = omma.pdbfile.PDBFile('./inputs/complex_largebox.pdb').getPositions()

pdb = mdj.load_pdb('./inputs/complex_largebox.pdb')
# protein and type!="H"'
...
simulation.reporters.append(
    omma.StateDataReporter(
        osp.join(OUTPUTS_PATH, LOG_FILE),
        LOG_REPORTER_STEPS,
        step=True,
        time=True,
